...
void server_setup() {
  ...
  AsyncCallbackJsonWebHandler* handler = new AsyncCallbackJsonWebHandler(
      "/drink", [](AsyncWebServerRequest* request, JsonVariant& json) {
        ...
        Serial.println(drink1_ml);
        Serial.println(drink2_ml);
        Serial.println(drink3_ml);
        Serial.println(drink4_ml);

        Serial.println(drink1_ms);
        Serial.println(drink2_ms);
        Serial.println(drink3_ms);
        Serial.println(drink4_ms);
